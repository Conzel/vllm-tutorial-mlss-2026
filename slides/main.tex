...
\input{sections/gpu-memory-hierarchy}
...
$$E[\text{tokens/round}] = 1 + \sum_{i=1}^\gamma \prod_{j=1}^i \alpha_j \stackrel{\text{if} \alpha_j = \alpha \forall j}{=} \frac{1-\alpha^{\gamma+1}}{1-\alpha}$$
